 ...
 */
  ...
  const renderProductCard = (product: any, index: number) => (
    <Card
      key={product.id}
      className={`bg-slate-800/50 dark:bg-slate-800/50 border-slate-700 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-cyan-500/20 hover:scale-105 group relative overflow-hidden transform ${
        productsInView ? "animate-slide-in-up opacity-100" : "opacity-0 translate-y-8"
      }`}
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-2 -right-2 w-4 h-4 bg-cyan-400/20 rounded-full animate-float opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div className="absolute top-1/2 -left-2 w-3 h-3 bg-blue-400/20 rounded-full animate-float-delayed opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div className="absolute -bottom-2 right-1/3 w-2 h-2 bg-purple-400/20 rounded-full animate-float-slow opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      </div>
      ...
      <CardHeader className="relative">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            {product.boostLevel && (
              <div className="mb-2">
                <Badge className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-300 border-cyan-500/30 text-xs animate-pulse-slow">
                  {product.boostLevel}
                </Badge>
              </div>
            )}
      ...
      <CardContent className="relative">
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            <span className="text-3xl font-bold text-white group-hover:text-cyan-400 transition-colors duration-300">
              {product.price}
            </span>
      ...
      >
        <div className="text-center">
          <div className="relative mb-8">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-2xl blur-3xl animate-pulse-glow"></div>
          </div>
          {/* Loading Animation */}
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl animate-float-delayed"></div>
      ...
      <section id="about" className="container mx-auto px-4 py-16 lg:py-24 relative" ref={heroRef}>
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div
              className={`inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6 animate-glow ${
            ...
            >
              ...
              <span className="text-cyan-400 text-sm font-medium">#1 Digital Marketplace</span>
            </div>
            <h1
            ...
            <p
              className={`text-xl md:text-2xl mb-8 leading-relaxed max-w-2xl lg:max-w-none ${
            ...
            >
              ...
              <Button
                ...
                className={`px-8 py-4 text-lg transition-all duration-300 hover:scale-105 ${
                  isDarkMode
                    ? "border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 bg-transparent"
                    : "border-cyan-500 text-cyan-600 hover:bg-cyan-50 bg-transparent"
                }`}
              >
                Browse Products
              </Button>
            ...
            >
              <div className="text-center lg:text-left group">
                <div
                  className={`text-2xl lg:text-3xl font-bold mb-1 group-hover:text-cyan-400 transition-colors duration-300 ${
                    isDarkMode ? "text-white" : "text-gray-900"
                  }`}
                >
                  150+
          ...
          >
            <div className="relative">
              ...
              <div
                className={`absolute -top-4 -left-4 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-3 hidden lg:block animate-float ${
              ...
              <div
                className={`absolute -bottom-4 -right-4 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-3 hidden lg:block animate-float-delayed ${
                  isDarkMode ? "bg-slate-800/90" : "bg-white/90"
                }`}
              >
                <div className="flex items-center gap-2">
              ...
              <div
                className={`absolute top-50 -left-8 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-3 hidden lg:block animate-bounce-subtle ${
                  isDarkMode ? "bg-slate-800/90" : "bg-white/90"
                }`}
              >
                <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          {[
            ...
            >
              <div
                className={`border rounded-2xl p-8 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-cyan-500/10 hover:scale-105 hover:-translate-y-2 ${
                  isDarkMode ? "bg-slate-800/50 border-slate-700" : "bg-white/50 border-gray-200"
                }`}
              >
                <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <feature.icon className="w-8 h-8 text-cyan-400 animate-pulse-slow" />
                </div>
      ...
      <section id="products" className="container mx-auto px-4 py-20" ref={productsRef}>
        <div className="text-center mb-16">
          <div
            className={`inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6 animate-glow ${
              productsInView ? "animate-slide-in-up" : "opacity-0 translate-y-8"
            }`}
          >
            <Crown className="w-4 h-4 text-cyan-400 animate-spin-slow" />
            <span className="text-cyan-400 text-sm font-medium">Premium Products</span>
          </div>
          <h2
          ...
          <p
            className={`text-lg max-w-3xl mx-auto leading-relaxed ${isDarkMode ? "text-gray-300" : "text-gray-600"} ${
              productsInView ? "animate-slide-in-up" : "opacity-0 translate-y-8"
            }`}
            style={{ animationDelay: "0.4s" }}
          >
...

{
      ...
      <section id="features" className="container mx-auto px-4 py-20" ref={featuresRef}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div
              className={`inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6 animate-glow ${
                featuresInView ? "animate-slide-in-left" : "opacity-0 -translate-x-8"
              }`}
            >
            ...
            <h3
              className={`text-3xl lg:text-4xl font-bold mb-8 ${isDarkMode ? "text-white" : "text-gray-900"} ${
                featuresInView ? "animate-slide-in-left" : "opacity-0 -translate-x-8"
              }`}
              style={{ animationDelay: "0.2s" }}
            >
            ...
            <div className="space-y-8">
              {[
                ...
                >
                  <div
                    className={`border rounded-lg p-3 group-hover:border-cyan-500/50 transition-all duration-300 group-hover:scale-110 ${
                      isDarkMode ? "bg-slate-800/50 border-slate-700" : "bg-white/50 border-gray-200"
                    }`}
                  >
                    <feature.icon className="w-6 h-6 text-cyan-400 animate-pulse-slow" />
                  </div>
                  <div>
                    <h4
                      className={`text-xl font-semibold mb-2 group-hover:text-cyan-400 transition-colors duration-300 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                    >
                      {feature.title}
                    </h4>
      ...
      <section id="contact" className="container mx-auto px-4 py-20" ref={contactRef}>
        <div className="text-center mb-16">
          <div
            className={`inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-2 mb-6 animate-glow ${
              contactInView ? "animate-slide-in-up" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          <p
            className={`text-lg max-w-3xl mx-auto leading-relaxed mb-12 ${isDarkMode ? "text-gray-300" : "text-gray-600"} ${
              contactInView ? "animate-slide-in-up" : "opacity-0 translate-y-8"
            }`}
            style={{ animationDelay: "0.4s" }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {[
            ...
            >
              <div
                className={`border rounded-2xl p-6 lg:p-8 hover:border-cyan-500/50 transition-all duration-500 hover:shadow-xl hover:shadow-cyan-500/10 hover:scale-105 hover:-translate-y-2 ${
                  isDarkMode ? "bg-slate-800/50 border-slate-700" : "bg-white/50 border-gray-200"
                }`}
              >
                <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full w-12 h-12 lg:w-16 lg:h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <feature.icon className="w-6 h-6 lg:w-8 lg:h-8 text-cyan-400 animate-pulse-slow" />
                </div>
      ...
      <section className="container mx-auto px-4 py-20" ref={ctaRef}>
        <div
          className={`bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-3xl p-8 md:p-16 text-center border border-cyan-500/30 relative overflow-hidden hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 ${
            ctaInView ? "animate-slide-in-up" : "opacity-0 translate-y-8"
          }`}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 rounded-3xl animate-pulse-glow"></div>
          {/* Animated particles */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <Sparkles className="absolute top-10 left-10 w-6 h-6 text-cyan-400/30 animate-twinkle" />
            ...
            <Rocket className="absolute bottom-10 right-10 w-8 h-8 text-cyan-400/20 animate-float" />
          </div>
          <div className="relative">
            <h2
      ...
      {/* Enhanced Footer */}
      <footer
        className={`container mx-auto px-4 py-12 border-t ${isDarkMode ? "border-slate-700" : "border-gray-200"} ${
          showContent ? "animate-slide-in-up" : "opacity-0 translate-y-8"
        }`}
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center space-x-3 mb-6 md:mb-0">
            ...
            />
            <Badge className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-400 border-cyan-500/30 text-xs animate-pulse-slow">
              Premium Quality
            </Badge>
          </div>
          <div className={`text-center md:text-right ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
            ...
            <div className="mt-3 flex items-center justify-center md:justify-end gap-2">
              ...
              <button
                ...
                className="text-cyan-400 hover:text-cyan-300 font-medium text-sm transition-colors duration-300 hover:underline relative group"
              >
                xOussamaii
                <div
                  className={`absolute -top-16 left-1/2 transform -translate-x-1/2 px-3 py-2 rounded-lg border text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 ${
      ...
      <Dialog open={showPurchaseModal} onOpenChange={setShowPurchaseModal}>
        ...
        >
          <DialogHeader>
            <DialogTitle className="text-cyan-400 text-2xl font-bold animate-slide-in-left">
          ...
          <div className="space-y-6">
            <div
              className={`p-6 rounded-xl border border-cyan-500/30 animate-slide-in-up ${isDarkMode ? "bg-slate-700/50" : "bg-cyan-50/50"}`}
              style={{ animationDelay: "0.2s" }}
            >
      ...
      {/* Developer Modal */}
        ...
        >
          <DialogHeader>
            <DialogTitle className="text-cyan-400 text-2xl font-bold animate-slide-in-left flex items-center gap-3">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold text-cyan-400 mb-2">xOussamaii</h3>
