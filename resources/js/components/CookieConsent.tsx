        ...
        <div className="bg-slate-800/90 backdrop-blur-xl border border-slate-700/50 rounded-lg shadow-2xl overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-2 p-4 md:p-5">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white transition-all duration-200 text-sm font-medium hover:shadow-lg hover:shadow-primary/25 disabled:opacity-50 disabled:cursor-not-allowed"
            >
